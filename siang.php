...
<body>
    ...
    <table border="1">
        ...
        $boot = mysqli_query($koneksi, "SELECT users.id, users.nama, bootcamp.no_bootcamp, bootcamp.bootcamp, bootcamp.jadwal_kelas from users inner join bootcamp on users.id=bootcamp.id where jadwal_kelas like '%Siang%'");
